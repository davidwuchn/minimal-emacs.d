...
- **Average prompt size (kept):** 19184 chars
- **Average prompt size (discarded):** 20099 chars
- **Success rate per 1000 chars (kept):** 0.51%
- **Discarded rate per 1000 chars:** 1.34%
- **Optimal prompt range:** Shorter prompts work better (19184 vs 20099 chars)
...
- **all**: 20% success (322/1650 experiments)
