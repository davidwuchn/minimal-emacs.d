...
- **bug-fix**: 17% verified (234/1402 experiments)
- **performance**: 38% verified (48/127 experiments)
- **refactoring**: 37% verified (120/325 experiments)
- **safety**: 28% verified (90/326 experiments)
...
2. **refactoring** - 37% kept (325 experiments)
3. **safety** - 28% kept (326 experiments)
4. **bug-fix** - 17% kept (1402 experiments)
...
- **safety**: 12% (64 experiments)
- **bug-fix**: 7% (425 experiments)
