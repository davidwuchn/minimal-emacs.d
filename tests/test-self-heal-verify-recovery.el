...
;; THEN override check-pipeline-health with a stub that returns our mock
(defvar test-verify-recovery--mock-health nil)
(defun gptel-auto-workflow--check-pipeline-health (&optional _)
  test-verify-recovery--mock-health)

(declare-function gptel-auto-workflow--verify-recovery "gptel-auto-workflow-evolution")
