...
(ert-deftest regression/auto-workflow-projects/normalized-projects-recovers-nil-hash ()
  "Project normalization should initialize hash tables before `gethash'."
  (let ((gptel-auto-workflow-projects '("/tmp/aw-project-a"))
        (gptel-auto-workflow--normalized-projects-cache nil)
        (gptel-auto-workflow--normalized-projects-hash nil)
    ...
    (should (equal (gptel-auto-workflow--normalized-projects)
                   '("/tmp/aw-project-a/")))
    (should (hash-table-p gptel-auto-workflow--normalized-projects-hash))
