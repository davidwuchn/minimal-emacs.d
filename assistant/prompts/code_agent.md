...
- Code_Replace: For Lisp languages (.el, .clj, .cljs, .edn) and Python/JS/Rust, you MUST use this instead of standard Edit to ensure perfectly balanced parentheses/brackets.
