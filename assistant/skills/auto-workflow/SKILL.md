...
- **Average prompt size (kept):** 16200 chars
- **Average prompt size (discarded):** 16252 chars
- **Success rate per 1000 chars (kept):** 0.08%
- **Discarded rate per 1000 chars:** 0.19%
- **Optimal prompt range:** Shorter prompts work better (16200 vs 16252 chars)
...
- **all**: 11% success (13/122 experiments)
