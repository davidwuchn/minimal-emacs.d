...
- **Average prompt size (kept):** 17709 chars
- **Average prompt size (discarded):** 18327 chars
- **Success rate per 1000 chars (kept):** 0.36%
- **Discarded rate per 1000 chars:** 0.78%
- **Optimal prompt range:** Shorter prompts work better (17709 vs 18327 chars)
...
- **all**: 22% success (135/603 experiments)
