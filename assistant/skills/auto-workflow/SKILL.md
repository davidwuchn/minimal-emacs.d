...
- **Average prompt size (kept):** 17671 chars
- **Average prompt size (discarded):** 18559 chars
- **Success rate per 1000 chars (kept):** 0.50%
- **Discarded rate per 1000 chars:** 1.21%
- **Optimal prompt range:** Shorter prompts work better (17671 vs 18559 chars)
...
- **all**: 21% success (89/430 experiments)
