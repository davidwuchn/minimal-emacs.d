...
- **Average prompt size (kept):** 16738 chars
- **Average prompt size (discarded):** 17067 chars
- **Success rate per 1000 chars (kept):** 0.21%
- **Discarded rate per 1000 chars:** 0.40%
- **Optimal prompt range:** Shorter prompts work better (16738 vs 17067 chars)
...
- **all**: 19% success (35/184 experiments)
