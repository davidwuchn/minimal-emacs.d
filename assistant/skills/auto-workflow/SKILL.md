...
- **Average prompt size (kept):** 17660 chars
- **Average prompt size (discarded):** 18533 chars
- **Success rate per 1000 chars (kept):** 0.50%
- **Discarded rate per 1000 chars:** 1.17%
- **Optimal prompt range:** Shorter prompts work better (17660 vs 18533 chars)
...
- **all**: 21% success (88/421 experiments)
