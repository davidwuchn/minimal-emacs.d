...
- **Average prompt size (kept):** 17705 chars
- **Average prompt size (discarded):** 18568 chars
- **Success rate per 1000 chars (kept):** 0.51%
- **Discarded rate per 1000 chars:** 1.22%
- **Optimal prompt range:** Shorter prompts work better (17705 vs 18568 chars)
...
- **all**: 21% success (91/434 experiments)
