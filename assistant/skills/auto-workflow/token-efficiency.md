...
- **Average prompt size (kept):** 19507 chars
- **Average prompt size (discarded):** 20479 chars
- **Success rate per 1000 chars (kept):** 0.55%
- **Discarded rate per 1000 chars:** 1.11%
- **Optimal prompt range:** Shorter prompts work better (19507 vs 20479 chars)
...
- **all**: 23% success (179/790 experiments)
