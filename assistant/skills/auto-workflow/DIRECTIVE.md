...
|--------|-----------|-------|------|--------|
| `lisp/modules/gptel-ext-tool-permits.el` | 50% | 4 | 2 | ✅ High yield |
...
- **other** (1129×): Investigate root cause
...
*This directive was auto-generated from 1300 experiments (248 kept locally across 1300 local records). It evolves every self-evolution cycle.*