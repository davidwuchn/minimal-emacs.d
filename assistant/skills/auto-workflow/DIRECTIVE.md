...
- **timeout** (106×): Add smaller batch sizes or chunked processing
...
*This directive was auto-generated from 946 experiments (161 kept locally across 946 local records). It evolves every self-evolution cycle.*