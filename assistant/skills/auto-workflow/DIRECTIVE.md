...
- **other** (143×): Investigate root cause
- **timeout** (23×): Add smaller batch sizes or chunked processing
- **validation-failed** (19×): Improve pre-grade validation prompts
...
*This directive was auto-generated from 870 experiments (14 kept locally across 197 local records). It evolves every self-evolution cycle.*