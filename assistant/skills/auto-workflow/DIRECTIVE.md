...
- **timeout** (87×): Add smaller batch sizes or chunked processing
...
*This directive was auto-generated from 907 experiments (197 kept locally across 907 local records). It evolves every self-evolution cycle.*