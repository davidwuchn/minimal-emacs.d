...
|--------|-----------|-------|------|--------|
| `lisp/modules/gptel-ext-tool-permits.el` | 38% | 8 | 3 | ✅ High yield |
| `lisp/modules/gptel-agent-loop.el` | 29% | 69 | 20 | 🟡 Active |
...
- **other** (1144×): Investigate root cause
- **validation-failed** (96×): Improve pre-grade validation prompts
...
- **lisp/modules/gptel-ext-tool-permits.el**: Apply Replace verbose prompts with compressed mathematical notation using λ calculus and EDN statecharts. (keep rate: 38%)
- **lisp/modules/gptel-agent-loop.el**: Apply Replace verbose prompts with compressed mathematical notation using λ calculus and EDN statecharts. (keep rate: 29%)
...
*This directive was auto-generated from 1318 experiments (249 kept locally across 1318 local records). It evolves every self-evolution cycle.*