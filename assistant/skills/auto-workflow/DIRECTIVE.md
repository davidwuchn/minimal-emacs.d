...
| `lisp/modules/gptel-tools-agent-experiment-core.el` | 0% | 7 | 0 | ❌ Plateaued |
...
*This directive was auto-generated from 870 experiments (2 kept locally across 39 local records). It evolves every self-evolution cycle.*