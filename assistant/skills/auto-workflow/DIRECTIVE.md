...
| `lisp/modules/gptel-tools-agent-prompt-build.el` | 7% | 15 | 1 | ❌ Plateaued |
| `lisp/modules/gptel-auto-workflow-research-integration.el` | 3% | 29 | 1 | ❌ Plateaued |
| `lisp/modules/gptel-auto-workflow-projects.el` | 2% | 59 | 1 | ❌ Plateaued |
...
- **other** (190×): Investigate root cause
...
*This directive was auto-generated from 870 experiments (16 kept locally across 250 local records). It evolves every self-evolution cycle.*