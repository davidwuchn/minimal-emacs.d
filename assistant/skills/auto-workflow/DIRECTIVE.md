...
- **other** (767×): Investigate root cause
- **timeout** (105×): Add smaller batch sizes or chunked processing
- **validation-failed** (41×): Improve pre-grade validation prompts
...
*This directive was auto-generated from 940 experiments (160 kept locally across 940 local records). It evolves every self-evolution cycle.*