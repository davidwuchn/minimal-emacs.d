...
| `lisp/modules/gptel-tools-agent-error.el` | 28% | 29 | 8 | 🟡 Active |
...
- **timeout** (107×): Add smaller batch sizes or chunked processing
...
*This directive was auto-generated from 947 experiments (161 kept locally across 947 local records). It evolves every self-evolution cycle.*