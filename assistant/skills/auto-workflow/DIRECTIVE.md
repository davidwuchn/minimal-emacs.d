...
| `lisp/modules/gptel-ext-context.el` | 26% | 27 | 7 | 🟡 Active |
...
| `lisp/modules/nucleus-tools.el` | 22% | 27 | 6 | 🟡 Active |
...
- **other** (1192×): Investigate root cause
- **validation-failed** (102×): Improve pre-grade validation prompts
- **timeout** (44×): Add smaller batch sizes or chunked processing
...
- **lisp/modules/gptel-benchmark-principles.el**: Apply Replace verbose prompts with compressed mathematical notation using λ calculus and EDN statecharts. (keep rate: 28%)
...
*This directive was auto-generated from 1380 experiments (254 kept locally across 1380 local records). It evolves every self-evolution cycle.*