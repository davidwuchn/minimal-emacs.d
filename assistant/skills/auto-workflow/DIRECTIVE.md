...
- **timeout** (2×): Add smaller batch sizes or chunked processing
...
*This directive was auto-generated from 870 experiments (0 kept locally across 6 local records). It evolves every self-evolution cycle.*