...
| `staging-review` | 0% | 5 | 0 | ⏳ Insufficient data |
| `lisp/modules/gptel-auto-workflow-projects.el` | 0% | 7 | 0 | ❌ Plateaued |
...
- **other** (58×): Investigate root cause
...
*This directive was auto-generated from 870 experiments (5 kept locally across 66 local records). It evolves every self-evolution cycle.*