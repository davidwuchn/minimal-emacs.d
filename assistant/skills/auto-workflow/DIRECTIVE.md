...
- **other** (3×): Investigate root cause
...
*This directive was auto-generated from 870 experiments (0 kept locally across 7 local records). It evolves every self-evolution cycle.*