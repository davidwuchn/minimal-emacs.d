...
|--------|-----------|-------|------|--------|
| `lisp/modules/gptel-benchmark-comparator.el` | 56% | 9 | 5 | ✅ High yield |
...
- **other** (738×): Investigate root cause
...
- **test-failure** (7×): Run tests before committing experiments
...
- **lisp/modules/gptel-benchmark-comparator.el**: Apply Removing Defensive JSON Key Lookups (keep rate: 56%)
...
*This directive was auto-generated from 906 experiments (156 kept locally across 906 local records). It evolves every self-evolution cycle.*