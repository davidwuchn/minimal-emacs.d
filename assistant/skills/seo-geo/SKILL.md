...
1. **Audit** the site (meta tags, schema, robots, sitemap).
2. **Research keywords** and user intent.
3. **Optimize content** for GEO + SEO.
4. **Validate** schema and indexing.

## Examples

**Good**: "Optimize example.com for AI search visibility"
- Audit with `seo_audit.py`
- Add FAQ schema, citations, and answer-first structure
- Validate with Rich Results Test

**Bad**: "Fix SEO"
- Missing target URL, keywords, and scope
