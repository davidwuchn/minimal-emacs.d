...
;; Version: 1.0.0
;;
;; Header-line UI components for nucleus gptel chat buffers.

(require 'subr-x)

;;; Customization

(defgroup nucleus-header-line nil
  "Header-line components for nucleus."
  :group 'nucleus)
...
(provide 'nucleus-header-line)

;;; nucleus-header-line.el ends here
