...
(declare-function gptel-auto-workflow--persist-subagent-process-environment "gptel-tools-agent-experiment-loop")
(declare-function gptel-auto-workflow--update-progress "gptel-tools-agent-experiment-loop")
(declare-function my/gptel--agent-task-buffer-priority "gptel-tools-agent-git")
(declare-function my/gptel--agent-task-buffer-tick "gptel-tools-agent-git")
(declare-function my/gptel--agent-task-note-context-activity "gptel-tools-agent-git")
(declare-function my/gptel--agent-task-request-buffer "gptel-tools-agent-git")
(declare-function my/gptel--agent-task-uses-idle-timeout-p "gptel-tools-agent-git")
(declare-function my/gptel--build-subagent-context "gptel-tools-agent-git")
(declare-function my/gptel--cancel-agent-task-timers "gptel-tools-agent-git")
(declare-function my/gptel--cleanup-agent-request-buffer "gptel-tools-agent-git")
...
(defun my/gptel--agent-task-note-write-region-activity (_start _end filename &rest _args)
  ...
  (when-let* ((path (and (stringp filename)
    ...
    (when (fboundp 'my/gptel--agent-task-note-context-activity)
