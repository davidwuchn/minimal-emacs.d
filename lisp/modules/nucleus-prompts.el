...
(defconst nucleus-tool-prompt-files
  '((Bash                . "bash.md")
    ...
    (Skill               . "skill.md")
    (describe_symbol     . "introspection.md")
    (get_symbol_source   . "introspection.md")
    (find_buffers_and_recent . "find_buffers_and_recent.md")
    (Edit                . "edit_file.md")
    (Move                . "move.md")
    (RunAgent            . "run_agent.md")
    (preview_file_change . "preview.md")
    (preview_patch       . "preview.md")
    (InlineDiffPreview   . "preview-enhanced.md")
    (BatchPreview        . "preview-enhanced.md")
    (SyntaxPreview       . "preview-enhanced.md")
    (Eval                . "eval.md")
    (Insert              . "insert.md")
    (Mkdir               . "mkdir.md")
