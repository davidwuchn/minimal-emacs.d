...
(declare-function gptel-auto-workflow-detect-mutation "gptel-tools-agent-main")
(declare-function gptel-auto-workflow-orient "gptel-tools-agent-main")
(declare-function gptel-auto-workflow-update-target-skill "gptel-tools-agent-main")
